...
data = []
with open('testResults/measurements/mplrs_excel_120t_5ss/excel_times.csv', 'r') as f:
    reader = csv.reader(f)
    for row in reader:
        phase = row[0]
...
# fig.suptitle(r'$\mathbf{Duration\ of\ Processing\ Phases\ -\ A.\ thaliana\ plastid\ (onto\ sugar\ and\ starch\ metabolism)}$', 
...
fig.text(
    ...
    r'$\mathbf{mplrs\ (threads=120,\ step\ size=5)}$',
    ha='center',
    va='top',
    fontsize=12,
    alpha=0.8
